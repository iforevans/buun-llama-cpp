...
bool ggml_metal_device_supports_op(ggml_metal_device_t dev, const struct ggml_tensor * op) {
    ...
    switch (op->op) {
        ...
        case GGML_OP_TURBO_WHT:
            // The Turbo WHT host declaration is retained for the split-kernel
            // migration, but its kernel still lives only in ggml-metal.metal.
            return false;
        ...
        case GGML_OP_SET_ROWS:
            {
                ...
                switch (op->type) {
                    ...
                    case GGML_TYPE_TURBO4_0:
                        // Keep the fork types explicit, but do not dispatch
                        // until their set-rows kernels move to kernels/*.metal.
                        return false;
                    case GGML_TYPE_TQ2_0:
                        return true;
                    default:
